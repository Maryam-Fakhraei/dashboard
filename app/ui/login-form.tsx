  ...
  return (
    <form action={formAction} className="space-y-3">
      <div className="flex-1 rounded-lg bg-stone-50 px-6 pb-4 pt-8">
        <h1 className={`${lusitana.className} mb-3 text-2xl text-emerald-900 px-8`}>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
              />
              <AtSymbolIcon className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-stone-500 peer-focus:text-stone-800" />
            </div>
          </div>
          <div className="mt-4">
            <label
